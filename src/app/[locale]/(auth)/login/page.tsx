  ...
  return (
    <div className="relative w-full max-w-[420px]">
      <div className="glass rounded-[var(--radius-card)] p-10">
        ...
        <h1 className="font-display text-2xl font-normal tracking-tight mb-1">Welcome back</h1>
        <p className="text-sm text-text-muted mb-8">Sign in to access your matches</p>

        <AuthForm mode="login" locale={locale} next={next} />

        <p className="text-center text-sm text-text-dim mt-6">
          No account?{' '}
          <a href={`/${locale}/signup`} className="text-accent hover:text-accent-hover transition-colors">
            Create one free
          </a>
        </p>
      </div>
